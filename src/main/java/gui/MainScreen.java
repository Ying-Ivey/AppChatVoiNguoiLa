	...
	public MainScreen() {
		...
		addWindowListener(new WindowListener() {
			...
			public void windowClosing(WindowEvent e) {
				...
				int PromptResult = JOptionPane.showOptionDialog(null, "Bạn có muốn rời khỏi đây không?", "Đăng xuất",
						JOptionPane.PLAIN_MESSAGE, JOptionPane.WARNING_MESSAGE, null, ObjButtons, ObjButtons[0]);
